...
<div class="container">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="{{URL::to('images/express/birla_ban.png')}}" alt="birla_banner">
    </div>

    <div class="item">
      <img src="{{URL::to('images/express/tribe_bann.png')}}" alt="tribe_banner">
    </div>
  </div>
				...
				<div class="col-md-3 animate-box">
					   <h3 style="background:#28a0ff;color:#fff; font-size:14px; padding:10px;">Business Loan</h3>
						<div class="price-box popular1">
							<div class="center-blg"><img src="{{URL::to('images/express/tata_capital.png')}}" alt="Tata Capital Logo" title="Tata Capital Logo" /></div>
						...
						<div class="price-box popular1">
							<div class="center-blg"><img src="{{URL::to('images/express/lendingkart.png')}}" alt="lendingkart Logo" title="lendingkart  Logo" /></div>
							<h4 class="mrg-btm">Business Loan</h4>
							<a class="btn btn-primary btn-outline with-arrow" href="{{URL::to('lendingkart')}}">Apply Now<i class="icon-arrow-right"></i></a>
						</div>
						
						<div class="price-box popular1">
							<div class="center-blg"><img src="{{URL::to('images/express/birla.png')}}" alt="Aditya Birla Logo" title="Aditya Birla Logo" /></div>
							<h4 class="mrg-btm">Business Loan</h4>
							<a class="btn btn-primary btn-outline with-arrow" onclick="Redirect();">Apply Now<i class="icon-arrow-right"></i></a>
						</div>
						
						<div class="price-box popular1">
							<div class="center-blg"><img src="{{URL::to('images/express/tribe.png')}}" alt="Tribe Logo" title="Tribe Logo" /></div>
							<h4 class="mrg-btm">Business Loan</h4>
							<a class="btn btn-primary btn-outline with-arrow" href="{{URL::to('tribe')}}">Apply Now<i class="icon-arrow-right"></i></a>
						</div>
						
						<div class="price-box popular1">
							<div class="center-blg"><img src="{{URL::to('images/express/edelweiss.png')}}" alt="Edelweiss Logo" title="Edelweiss Logo" /></div>
							<h4 class="mrg-btm">Business Loan</h4>
							<a class="btn btn-primary btn-outline with-arrow" href="{{URL::to('edelweiss')}}">Apply Now<i class="icon-arrow-right"></i></a>
						</div>
						
						<div class="price-box popular1">
							<div class="center-blg"><img src="{{URL::to('images/express/hdfc.png')}}" alt="HDFC Logo" title="HDFC Logo" /></div>
						...
						<div class="price-box popular1">
							<div class="center-blg"><img src="{{URL::to('images/express/capital_first.png')}}" alt="Capital First Logo" title="Capital First Logo" /></div>
							<h6 class="text-center text-danger"><i>Coming Soon</i></h6>
							<h4 class="mrg-btm">Business Loan</h4>
							<a class="btn btn-primary btn-outline with-arrow" href="{{URL::to('contact-us')}}">Apply Now<i class="icon-arrow-right"></i></a>
						</div>
						...
						<div class="price-box popular1">
							<div class="center-blg"><img src="{{URL::to('images/express/capital_float.png')}}" alt="Capital Float Logo" title="Capital Float Logo" /></div>
							<h6 class="text-center text-danger"><i>Coming Soon</i></h6>
							<h4 class="mrg-btm">Business Loan</h4>
							<a class="btn btn-primary btn-outline with-arrow" href="{{URL::to('contact-us')}}">Apply Now<i class="icon-arrow-right"></i></a>
						</div>
					...
					<div class="col-md-3 animate-box">
					   <h3 style="background:#28a0ff;color:#fff; font-size:14px; padding:10px;">Personal Loan</h3>
						<div class="price-box popular1">
							<div class="center-blg"><img src="{{URL::to('images/express/rbl.png')}}" alt="RBL Logo" title="RBL Logo" /></div>
						...
						<div class="price-box popular1">
							<div class="center-blg"><img src="{{URL::to('images/express/kotak.png')}}" alt="Kotak Logo" title="Kotak Logo" /></div>
							<h4 class="mrg-btm">Personal Loan</h4>
							<a class="btn btn-primary btn-outline with-arrow" href="{{URL::to('kotak-personal-loan')}}">Apply Now<i class="icon-arrow-right"></i></a>
						</div>
						
						<div class="price-box popular1">
							<div class="center-blg"><img src="{{URL::to('images/express/iifl.png')}}" alt="IIFL Logo" title="IIFL Logo" /></div>
							<h4 class="mrg-btm">Personal Loan</h4>
					...
					<div class="col-md-3 animate-box">
					   <h3 style="background:#28a0ff;color:#fff; font-size:14px; padding:10px;">Home Loan</h3>
						...
						<div class="price-box popular1">
							<div class="center-blg"><img src="{{URL::to('images/express/yesbank.png')}}" alt="Yes Logo" title="Yes Logo" /></div>
							<h4 class="mrg-btm">Home Loan</h4>
							<a class="btn btn-primary btn-outline with-arrow" href="{{URL::to('yesbank-home-loan')}}">Apply Now<i class="icon-arrow-right"></i></a>
						</div>
						...
						<div class="price-box popular1">
							<div class="center-blg"><img src="{{URL::to('images/express/vastu.png')}}" alt="Vastu Logo" title="Vastu Logo" /></div>
							<h6 class="text-center text-danger"><i>Coming Soon</i></h6>
							<h4 class="mrg-btm">Home Loan</h4>
							<a class="btn btn-primary btn-outline with-arrow" href="{{URL::to('contact-us')}}">Apply Now<i class="icon-arrow-right"></i></a>
						</div>
					...
					<div class="col-md-3 animate-box">
					   <h3 style="background:#28a0ff;color:#fff; font-size:14px; padding:10px;">Short Term Personal Loan</h3>
						<div class="price-box popular1">
							<div class="center-blg"><img src="{{URL::to('images/express/early.png')}}" alt="Early Salary Logo" title="Early Salary Logo" /></div>
						...
						<div class="price-box popular1">
							<div class="center-blg"><img src="{{URL::to('images/express/pay.png')}}" alt="Pay Sense Logo" title="Pay Sense Logo" /></div>
							<h6 class="text-center text-danger"><i>Coming Soon</i></h6>
							<h4 class="mrg-btm">Short Term Personal Loan</h4>
							<a class="btn btn-primary btn-outline with-arrow" href="{{URL::to('contact-us')}}">Apply Now<i class="icon-arrow-right"></i></a>
						</div>
