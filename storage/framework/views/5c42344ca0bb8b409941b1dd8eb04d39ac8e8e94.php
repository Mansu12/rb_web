...
<!--  <p class="text-left">home/<?php echo e($product); ?></p> -->
  ...
  <div class="iframeloading" style= "display:none;position:absolute; top: 0px; left: 0px; width: 100%; height: 100%;">
                <img src="<?php echo e(URL::to('images/ajaxloader.gif')); ?>" alt="Loader" title="Loader" style="top: 50%; position: relative; left: 50%;"  /> </div>
  </div>
...
<table width="100%" border="1" class="tbl">
  ...
  <tr>
   ...
   <input type="hidden" name="product" class="product" value="<?php echo e($product); ?>">
    ...
    <td class="upper"><!-- <a href="#">Know More</a>  --><button type="button" data-toggle="collapse" data-target="#<?php echo e($key); ?>"><span class="hidden-xs">Know</span> More</button></td>
