<?php echo $__env->make('layout.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <div class="col-md-12">
        ...
        <div class="col-md-4">
            <div class="desc">
              <a href="<?php echo e(url('credit-card-compare/sbi')); ?>">  <img src="images/sbi_credit_crd.jpg" alt="SBI Credit Cards" title="SBI Credit Cards" class="img-responsive box-shadow"/></a>
            </div>
        </div>
   </div>
        </div> 
